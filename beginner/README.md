...
Welcome to the **Beginner** section of the AI Learning Resources. This section uses plain language and real-world examples to help anyone — regardless of technical background — understand and start using AI tools.
...
Once you've worked through these beginner topics, you might be ready to explore the technical side of AI!

**[→ Explore the Advanced AI Section](../advanced/README.md)**

The advanced section covers neural networks, model architectures, training techniques, fine-tuning, evaluation, RAG, AI agents, and safety & alignment — written for developers and technical learners who want to understand how AI really works under the hood.
